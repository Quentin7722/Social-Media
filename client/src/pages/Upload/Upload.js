  ...
  return (
    <main className="Upload">
      <article className="UploadForm">
        ...
        <label className="label-img" htmlFor="input-title">
          Choisir un titre
        </label>
        <input
          id="input-title"
        ...
        />
        <label className="label-img" htmlFor="textarea-description">
        ...
        ></textarea>
        <label className="label-img" htmlFor="file">
          Choisir une image
        </label>
        <input
          id="file"
        ...
        />
        <button ref={reference} value="Publication" onClick={() => upload()}>
          Publier
        </button>
      </article>
