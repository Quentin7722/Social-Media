...
Executez la commande ``yarn start`` dans un terminal depuis le répertoire "client" pour lancer l'application front-end et la commande ``node server`` depuis le répertoire "serveur" pour l'application back-end.
